...
public class Student implements Comparable {
	...
	public Student(int id, String fullName, Date birthDate, double avgMark) {
		...
		//System.out.println("in the constructor==id=="+this.id+"\tfullname=="+this.fullName+"\tbirth=="+this.birthDate);
	}
	/*public String toString(){
		return "in the constructor==id=="+this.id+"\tfullname=="+this.fullName+"\tbirth=="+this.birthDate;
	}*/
	public int getId() {
		return id;
	}
